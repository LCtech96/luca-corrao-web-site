        ...
        <div className="container mx-auto px-3 sm:px-4 py-3">
          <div className="flex items-center justify-between gap-2 min-w-0">
            <Button
              ...
              size="icon"
              onClick={onClose}
              className="shrink-0 text-gray-300 hover:text-cyan-400 hover:bg-cyan-500/10"
              aria-label={t.aiSolutions.backHome}
            >
              <ArrowLeft className="w-5 h-5" />
            </Button>
            <h1 className="text-base sm:text-2xl font-bold text-white bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent truncate text-center min-w-0">
              {t.aiSolutions.title}
            </h1>
